$(function () {
    ...
    document.querySelectorAll('.x-button').forEach(x => x.addEventListener("mousedown", (function () {
                button_x.classList.remove("x-button-choose");
                button_x.classList.add("x-button");
    ...
    function init() {
        button_x = document.getElementById('main-f:x-button-default');
        if (!button_x.classList.contains("x-button-choose")) {
            button_x.classList.add("x-button-choose");
            button_x.classList.remove("x-button");
        }
        document.getElementById("main-f:inputX").value = button_x.innerText;
    }
